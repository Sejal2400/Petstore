...
def orders_history(request):
    ...
    #retrive order along with associated order item
    orders = OrderPet.objects.filter(user=user).select_related('order_id','Pet')
    ...
    return render(request,'base/orders_history.html',content)