...
def create_order_pdf(order,cart_items):
    ...
    #for spacing between customer detail & item table.
...
def send_order_email(order,cart_items):
    print("Insdie send email")
    subject = "Your Order Details" 
    from_email = settings.DEFAULT_FROM_EMAIL  #LOCAL HOST
    recipient_email = order.user.email 
    
    email_body = "Thank you For Placing The order, please Find Attached invoice for your reference"
